...
print(p.stdout)
log = re.sub(r"\x1b\[[0-?]*[ -/]*[@-~]", "", p.stdout)
counts=re.findall(r"\b(\d+) commits scanned",log)
errors=re.search(r"(?mi)(?:\bfatal:|\b(?:ERR|FTL)\b|Invalid revision|unknown revision|bad object)",log)
